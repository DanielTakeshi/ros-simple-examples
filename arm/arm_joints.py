...
class ArmJoints(object):
    ...
    # No limits for `upperarm_roll`, `forearm_roll`, `wrist_roll`.
    JOINT_LIMITS = {
...
if __name__ == "__main__":
    # These aren't going to do anything, needs to be set on the actual robot.
    js = ArmJoints()

    # Possible configuration from Justin Huang
    #js.set_shoulder_pan(1.5)
    #js.set_shoulder_lift(-0.6)
    #js.set_upperarm_roll(3.0)
    #js.set_elbow_flex(1.0)
